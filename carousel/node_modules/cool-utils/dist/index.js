...
var clsnames = _interopDefault(require('classnames'));
var React = require('react');
var React__default = _interopDefault(React);
var URLSearchParams = _interopDefault(require('url-search-params'));
...
var omitNil = function omitNil(obj) {
  return lodashEs.pickBy(obj, function (value) {
...
function getDifferentiation(val, prevVal) {
  var added = lodashEs.differenceWith(val, prevVal, lodashEs.isEqual);
  var removed = lodashEs.differenceWith(prevVal, val, lodashEs.isEqual);
  return {
    added: added,
    removed: removed
  };
...
var highlightText = function highlightText(_ref) {
  ...
  textArr.forEach(function (item, index) {
    elementArr.push( /*#__PURE__*/React__default.createElement("span", {
      key: key,
...
var debounce = function debounce(wait, options) {
  return function (_target, _propertyKey, descriptor) {
    ...
    descriptor.value = lodashEs.debounce(descriptor.value, wait, options);
  };
};
...
var throttle = function throttle(wait, options) {
  return function (_target, _name, descriptor) {
    // eslint-disable-next-line no-param-reassign
    descriptor.value = lodashEs.throttle(descriptor.value, wait, options);
  };
};
...
function usePrevious(value, initValue) {
  ...
  var curRef = React.useRef(initValue);
...
function useAdvancedCompare(vals) {
  var _ref = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
      ...
      comparator = _ref$comparator === void 0 ? lodashEs.isEqual : _ref$comparator,
...
function useCompare() {
  ...
  var isDifferent = !lodashEs.isEqual(prevVals, vals);
...
function useEventListener(eventName, handler) {
  ...
  var savedHandler = React.useRef(console.log); // Update ref.current value if handler changes.
...
function usePreviousProp(value, initValue) {
  var ref = React.useRef(initValue);
  React.useEffect(function () {
    ref.current = value;
  });
  return ref.current;
  ...
  function Http() {
    ...
    this.commonConfig = {
      ...
      dataInterceptor: [function omitNil(data) {
        return lodashEs.omitBy(data, function isNil(value) {
          return value === undefined || value === null;
        });
      }],
      requestInterceptor: [],
...
exports.adjustToPage = adjustToPage;
exports.axios = axios;
exports.axiosDelete = deleteMethod;
exports.axiosForm = form;
exports.axiosGet = get;
exports.axiosMethods = axiosMethods;
exports.axiosPost = post;
exports.axiosPut = put;
exports.base = base;
exports.bind = bind;
exports.classnames = classnames;
exports.console2 = console2;
exports.ctrlMetaToString = ctrlMetaToString;
exports.debounce = debounce;
exports.deleteMethod = deleteMethod$1;
...
exports.getDifferentiation = getDifferentiation;
exports.getJS = getJS;
...
exports.isCtrlMetaPress = isCtrlMetaPress;
exports.isFile = isFile;
exports.isFormData = isFormData;
exports.isFunction = isFunction;
exports.isMatchKey = isMatchKey;
exports.isObject = isObject;
exports.isStream = isStream;
exports.isString = isString;
exports.jsonp = jsonp;
exports.keyboardMan = keyboardMan;
exports.loadScripts = loadScripts;
exports.loadStyles = loadStyles;
exports.merge = merge;
exports.objToParams = objToParams;
exports.objectToFormData = objectToFormData;
exports.omitNil = omitNil;
exports.post = post$1;
...
exports.setAxiosOptions = setAxiosOptions;
exports.stringToDomElement = stringToDomElement;
exports.throttle = throttle;
exports.urlAddParams = urlAddParams;
exports.urlParseParams = urlParseParams;
exports.useAdvancedCompare = useAdvancedCompare;
exports.useCompare = useCompare;
exports.useDifferentiation = useDifferentiation;
exports.useEventListener = useEventListener;
exports.useHistory = useHistory;
exports.usePrevious = usePrevious;
exports.usePreviousProp = usePreviousProp;
